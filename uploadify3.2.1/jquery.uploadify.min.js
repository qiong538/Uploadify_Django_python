                ...
                if (e[0]) {
                    if (e[0] == "*") {
                        ...
                        c("#" + j.queueID).find(".uploadify-queue-item").each(function () {
                            ...
                            c(this).delay(50 + 100 * h).fadeOut(50, function () {
                                c(this).remove();
                            });
                        });
                        ...
                        for (var m = 0; m < e.length; m++) {
                            i.cancelUpload(e[m]);
                            // delete files by LiangBaoqiong
                            delete i.queueData.files[e[m]];
                            i.queueData.queueLength = i.queueData.queueLength - 1;

                            c("#" + e[m]).find(".data").removeClass("data").html(" - Cancelled");
                            c("#" + e[m]).find(".uploadify-progress-bar").remove();
                            c("#" + e[m]).delay(50 + 100 * m).fadeOut(50, function () {
                                c(this).remove();
                            });
                        }
                    }
